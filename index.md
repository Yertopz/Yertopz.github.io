...
<div id="root">
  <div class="bg-gradient3">
    ...
    <section class="position-relative hero-13 overflow-hidden pt-7 pt-lg-8 pb-5 hero-with-shapes">
      <div class="container">
        <div class="align-items-center text-center text-sm-start row">
          <div class="col-lg-6">
            <div class="mb-lg-0">
              <h1 class="hero-title">由 fun带领团队制作 <br>使用多种注入写法<br><span> 
				  <span class="highlight highlight-success d-inline-block">666你这个入开贵了</span>
              ...
              <p class="fs-18 text-muted pt-3">由fun带领团队设计和开发的注入，让您开上宝马。</p>
              <div class="pt-3 pt-sm-5 mb-4 mb-lg-0"><a href="https://qm.qq.com/q/KhQSZOV76U" class="btn btn-secondary me-2" data-toggle="smooth-scroll" target="_blank">赞助地址 </a><a href="https://ifdian.net/a/fishGC" class="btn btn-danger me-2" data-toggle="smooth-scroll" target="_blank">视频教程 </a> </div>
            </div>
          </div>
            ...
            <div class="img-container">
              <div class="slider">
                <div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events">
					<img src="./image/2.jfif" alt="" class="img-fluid d-block ms-auto rounded-lg"> </div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-lg-6 py-4 mt-0 coworking-1">
      <div class="container">
        <div class="align-items-center row">
          <div class="col">
            <div class="text-center"><span class="badge-soft-info px-2 py-1 badge rounded-pill">关于</span>
              <h1 class="display-5 fw-medium">稳定的科技颅内高超的演技</h1>
              <p class="text-muted mx-auto w-75 mt-1">无论你是什么 lol 高手，是lol还是乐子，用钓鱼老客户端直接钓出宝马</p>
              <div data-aos="fade-up" class="mt-5 text-center row aos-init aos-animate">
                <div class="mb-5 mb-sm-0 col-md-3 col-6">
                  <div class="display-3 fw-bold"><span>114514+</span></div>
                  <p class="mt-1 mb-0">代码数</p>
                </div>
                <div class="mb-5 mb-sm-0 col-md-3 col-6">
                  <div class="display-3 fw-bold"><span>114514+</span></div>
                  <p class="mt-1 mb-0">编写时长</p>
                </div>
                <div class="mb-5 mb-sm-0 col-md-3 col-6">
                  <div class="display-3 fw-bold"><span>72</span></div>
                  <p class="mt-1 mb-0">用戶数量</p>
                </div>
                <div class="mb-5 mb-sm-0 col-md-3 col-6">
                  <div class="display-3 fw-bold"><span>Minecraft</span></div>
                  <p class="mt-1 mb-0">支持游戏</p>
                </div>
              </div>
            </div>
          </div>
	...
	<section class="my-lg-5 py-5 py-sm-7 bg-gradient2 position-relative aos-init aos-animate" data-aos="fade-up">
      <div class="container">
        <div class="row">
          <div data-aos="fade-up" class="text-center col aos-init aos-animate"><span class="badge-soft-primary px-2 py-1 badge rounded-pill">特点</span>
            <h1 class="display-4 fw-semibold">为什么选择Fish</h1>
          </div>
        </div>
        <div class="mt-5 row">
        ...
        <div id="poc" class="align-items-center row">
          <div class="col-lg-5">
            <div class="mb-lg-0 mb-4 aos-init aos-animate" data-aos="fade-right" data-aos-duration="600">
				<span class="badge-soft-primary px-2 py-1 badge rounded-pill">Fish科技</span>
              <div id="apexml" class="align-items-center  row">
                <div class="col-lg-8">
                  <h1 class="display-5 fw-medium mb-2">钓鱼式注入</h1>
                </div>
                <!--
              <div class="col-lg-4" style="display: flex; justify-content: right;"><a class="btn btn-primary ms-0" href="/products/poc">了解更多
...
--> 
              ...
              <h5 class="fw-normal text-muted mx-auto mt-0 mb-4 pb-3">fw产品</h5>
              <div class="d-flex mb-3">
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">支持w7系统及以上</div>
              </div>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">追求稳定，用户独立版本</div>
              </div>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">开机运行一次 不读取任何游戏数据</div>
              </div>
            </div>
          </div>
          <div class="col-lg-6 offset-lg-1">
            <div class="bg-white p-2 rounded border shadow aos-init aos-animate" data-aos="fade-right" data-aos-duration="600"> <img width="100%" height="315" src="1.jfif"/> </div>
          </div>
        </div>
        ...
        <div class="align-items-center row">
          <div class="col-lg-5">
            <div class="mb-lg-0 mb-4 aos-init aos-animate" data-aos="fade-right" data-aos-duration="600"><span class="badge-soft-primary px-2 py-1 badge rounded-pill">Fish科技</span>
              <div class="align-items-center  row">
                <div class="col-lg-8">
                  <h1 class="display-5 fw-medium mb-2">一键自毁</h1>
                </div>
                <!--
              <div class="col-lg-4" style="display: flex; justify-content: right;"><a class="btn btn-primary ms-0" href="/products/poc">了解更多
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right icon icon-xxs ms-1">
...
--> 
              ...
              <h5 class="fw-normal text-muted mx-auto mt-0 mb-4 pb-3">支持对掏一键卸载</h5>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check icon-dual-primary">
                    <g>
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">支持w7-w11 </div>
              </div>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-repeat icon-dual-primary">
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">支持漏哪打哪 剑剑到肉</div>
              </div>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-server icon-dual-primary">
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">垃圾服务器支持</div>
              </div>
            </div>
          </div>
          <div class="col-lg-6 offset-lg-1">
        ...
        <div class="align-items-center row">
          <div class="col-lg-5">
            <div class="mb-lg-0 mb-4 aos-init aos-animate" data-aos="fade-right" data-aos-duration="600"><span class="badge-soft-primary px-2 py-1 badge rounded-pill">Fish科技</span>
              <div class="align-items-center  row">
                <div class="col-lg-8">
                  <h1 class="display-5 fw-medium mb-2">aim自瞄</h1>
                </div>
                <!--
              <div class="col-lg-4" style="display: flex; justify-content: right;"><a class="btn btn-primary ms-0" href="/products/poc">了解更多
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right icon icon-xxs ms-1">
...
--> 
              ...
              <h5 class="fw-normal text-muted mx-auto mt-0 mb-4 pb-3">垃圾服务器 精修模型</h5>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check icon-dual-primary">
                    <g>
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">自带无敌客服</div>
              </div>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-repeat icon-dual-primary">
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">更隐蔽的隐藏方式</div>
              </div>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-server icon-dual-primary">
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">参数可调节</div>
              </div>
            </div>
          </div>
          <div class="col-lg-6 offset-lg-1">
        ...
        <div class="align-items-center row">
          <div class="col-lg-5">
            <div class="mb-lg-0 mb-4 aos-init aos-animate" data-aos="fade-right" data-aos-duration="600"><span class="badge-soft-primary px-2 py-1 badge rounded-pill">Fish科技</span>
              <div class="align-items-center  row">
                <div class="col-lg-8">
                  <h1 class="display-5 fw-medium mb-2">killaura</h1>
                </div>
                <!--
              <div class="col-lg-4" style="display: flex; justify-content: right;"><a class="btn btn-primary ms-0" href="/products/poc">了解更多
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right icon icon-xxs ms-1">
...
--> 
              ...
              <h5 class="fw-normal text-muted mx-auto mt-0 mb-4 pb-3">疯狂绕过宝马岛
              </h5>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check icon-dual-primary">
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">支持win7-win11</div>
              </div>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-repeat icon-dual-primary">
                ...
                <div class="fw-medium fs-16 align-self-center flex-grow-1">支持开上宝马</div>
              </div>
              <div class="d-flex mb-3">
                <div class="list-inline-item me-3 flex-shrink-0"><span class="bg-soft-primary avatar avatar-sm rounded-lg icon icon-with-bg icon-xs text-primary">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-server icon-dual-primary">
